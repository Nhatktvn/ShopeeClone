          ...
          <div className='lg:col-span-2 lg:col-start-4'>
            <form onSubmit={handleSubmit} className='p-10 rounded bg-white shadow-sm'>
              ...
              <div className='w-full text-sm flex justify-center gap-5 mt-7'>
                <button className='w-[40%] border border-gray-400 rounded-sm py-2 flex items-center justify-center gap-1 active:bg-slate-300'>
                ...
                <button className='w-[40%] border border-gray-400 rounded-sm py-2 flex items-center justify-center gap-1'>
                  <svg
