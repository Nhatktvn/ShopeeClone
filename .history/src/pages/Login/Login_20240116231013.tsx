          ...
          <div className='lg:col-span-2 lg:col-start-4'>
            <form onSubmit={handleSubmit} className='p-10 rounded bg-white shadow-sm'>
              ...
              <button
                ...
                className={`w-full p-3 bg-orange text-white font-medium mt-5 rounded-sm ${!inputPassword || !inputUsername ? 'cursor-not-allowed opacity-[0.7]' : 'cursor-pointer hover:opacity-[0.9] active:bg-[#e2492b]'}`}
              >
                ĐĂNG NHẬP
              </button>
