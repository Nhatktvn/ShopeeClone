          ...
          <div className='lg:col-span-2 lg:col-start-4'>
            <form onSubmit={handleSubmit} className='p-10 rounded bg-white shadow-sm'>
              ...
              <button
                type='submit'
                disabled={!inputPhone}
                className={`w-full p-3 bg-orange text-white font-medium mt-5 rounded-sm active:bg-[#e2492b] ${!inputPhone ? 'cursor-not-allowed opacity-[0.7]' : 'cursor-pointer hover:opacity-[0.9]'}`}
              >
                TIẾP THEO
              </button>
